<?php
    ...
    define( 'K_SITE_URL', 'http://dolfst.bget.ru/' ); 
    ...
    define( 'K_DB_NAME', 'dolfst_couchcms' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'dolfst_couchcms' );
    // 6.
    // Database password 
    define( 'K_DB_PASSWORD', '5d743574s3' );
    // 7.
